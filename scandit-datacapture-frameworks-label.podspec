Pod::Spec.new do |s|
    ...
    s.source                  = { :git => 'https://github.com/Scandit/scandit-datacapture-frameworks-label.git', :tag => '7.6.8' }
    s.swift_version           = '5.7'
    ...
    s.dependency 'ScanditLabelCapture', '= 7.6.8'
    s.dependency 'scandit-datacapture-frameworks-barcode', '= 7.6.8'
end
