Pod::Spec.new do |s|
    ...
    s.source                  = { :git => 'https://github.com/Scandit/scandit-datacapture-frameworks-label.git', :tag => '8.1.3' }
    s.swift_version           = '5.7'
    ...
    s.dependency 'ScanditLabelCapture', '= 8.1.3'
    s.dependency 'scandit-datacapture-frameworks-barcode', '= 8.1.3'
end
